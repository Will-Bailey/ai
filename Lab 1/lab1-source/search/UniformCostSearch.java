...
import search.PathLengthComparator;
import java.util.*;
...
public class UniformCostSearch {
    ...
    PathLengthComparator comparator;
    static int counter = 0;


    public UniformCostSearch(State initialState) {
        comparator = new PathLengthComparator(); 
...
//        int[][] v = {{1, 2, 5}, {3, 4, 0}, {6, 7, 8}};
        ...
        UniformCostSearch ucs = new UniformCostSearch(st);
        Node goal = ucs.findPathToGoal();
