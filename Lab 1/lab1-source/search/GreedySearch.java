...
import search.GreedyComparator;
import java.util.*;
...
public class GreedySearch {
    ...
    GreedyComparator comparator;
    static int counter = 0;


    public GreedySearch(State initialState) {
        comparator = new GreedyComparator(); 
        frontier = new PriorityQueue(1, comparator);
...
//        int[][] v = {{1, 2, 5}, {3, 4, 0}, {6, 7, 8}};
        ...
        GreedySearch gs = new GreedySearch(st);
        Node goal = gs.findPathToGoal();
